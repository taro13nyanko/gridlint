...
Six kinds of defect, planted into twelve base workbooks, **every mutant re-opened and
...
|---|---|---:|---:|---:|---:|
| R001 | `SUM` range shortened by one row | 23 | 23 | 100% | 14 |
| R002 | one formula in a copied row hand-edited | 22 | 22 | 100% | 22 |
...
## False positives — 0 across 1,368 formulas
...
|---|---:|---:|---:|
| clean-00 … clean-11 | 1,368 total | 1,368 / 1,368 | **0** |
